...
@section('title', 'Editar ou Excluir Cadastro da Empresa')
    ...
    <fieldset>
        <div class="form-row col-msm">   
            <div class="form-group col-sm-12">
                <span class="col-1 p-0">Nome Fantasia</span>
            ...
            <div class="form-group col-sm-8">    
                ...
                <input class="form-control"  type="text" maxlength="40" name="Razao Social" placeholder="Razão social da empresa"  
                value="{{isset($registros['responsavel']) ? $registros['responsavel'] : ''}}" required>
            </div>
            
            <div class="form-group col-sm-4">
                <span>CNPJ</span>
                <input class="form-control" type="juridica" maxlength="14" name="CNPJ" placeholder="99.999.999/9999-99" 
                value="{{isset($registros['cnpj']) ? $registros['cnpj'] : ''}}" pattern="[0-9]{2}.[0-9]{3}.[0-9]{3}/[0-9]{4}-[0-9]{2}$" 
                title="Número de Cadastro de Pessoa Jurídica" required>
            </div> 
